...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider data =
            MapleDataProviderFactory.getDataProvider(new File(wzPath + "/Mob.wz"));
    private static final MapleDataProvider stringDataWZ =
            MapleDataProviderFactory.getDataProvider(new File(wzPath + "/String.wz"));
    ...
    public static Map<Integer, MapleMonsterStats> getAllMonsterStats() {
        ...
        for (MapleDataFileEntry mFile : root.getFiles()) {
            try {
                ...
                // System.out.println("[SEVERE] " + mFile.getName() + " failed to load. Issue: " +
                // npe.getMessage() + "\n\n");
            }
        }
