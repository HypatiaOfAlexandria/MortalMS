...
public class GenericLittleEndianAccessor implements LittleEndianAccessor {
    ...
    /**
     * Reads an ASCII string from the stream with length {@code n}.
     *
    ...
    /**
     * Reads {@code num} bytes off the stream.
     *
     * @param num The number of bytes to read.
     * @return An array of bytes with the length of {@code num}
     */
    @Override
    ...
    /**
     * Skips the current position of the stream {@code num} bytes ahead.
     *
