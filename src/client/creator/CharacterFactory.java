...
public abstract class CharacterFactory {
    ...
    protected static synchronized int createNewCharacter(
            MapleClient c,
            String name,
            int face,
            int hair,
        ...
        if (ServerConstants.COLLECTIVE_CHARSLOT
                ? c.getAvailableCharacterSlots() <= 0
        ...
        newchar.gainAp(13, true);
        recipe.setRemainingAp(13);
        ...
        Server.getInstance()
                .broadcastGMMessage(
                        ...
                        MaplePacketCreator.sendYellowTip(
                                "[NEW CHAR]: "
                                        + c.getAccountName()
                                        + " has created a new character with IGN "
                                        + name));
