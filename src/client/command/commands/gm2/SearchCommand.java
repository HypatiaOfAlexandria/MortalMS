...
public class SearchCommand extends Command {
    ...
    public void execute(MapleClient c, String[] params) {
            ...
            if (data != null) {
                ...
                for (MapleData searchData : data.getChildren()) {
                    ...
                    if (name.toLowerCase().contains(search.toLowerCase())) {
                        sb.append("#b")
                                .append(Integer.parseInt(searchData.getName()))
                                .append("#k - #r")
                                .append(name)
                                .append('\n');
                    }
        ...
        sb.append("\n#kLoaded within ")
                .append((double) (System.currentTimeMillis() - start) / 1000.0d)
                .append(" seconds."); // because I can, and it's free

        c.announce(
                MaplePacketCreator.getNPCTalk(9010000, (byte) 0, sb.toString(), "00 00", (byte) 0));
    }
}
