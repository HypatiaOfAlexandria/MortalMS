...
public class AutobanManager {
    ...
    public void addPoint(AutobanFactory fac, String reason) {
        ...
        FilePrinter.printError(
                "autobanwarning.txt",
                MapleCharacter.makeMapleReadable(chr.getName())
                        + " caused "
                        + fac.name()
                        + ' '
                        + reason
    ...
    public void resetMisses() {
        ...
        if (samemisscount > 4) chr.sendPolice("You will be disconnected for miss godmode.");
    ...
    /**
     * Timestamp checker {@code type}:<br>
     * 1: Pet Food<br>
     * 2: InventoryMerge<br>
     * 3: InventorySort<br>
     * 4: SpecialMove<br>
