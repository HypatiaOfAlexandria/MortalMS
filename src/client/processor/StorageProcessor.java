            ...
            if (mode == 4) { // take out
                ...
                if (slot < 0 || slot > storage.getSlots()) { // removal starts at zero
                    ...
                    FilePrinter.print(
                            ...
                            c.getPlayer().getName()
                                    + " tried to work with storage slot "
                                    + slot
                ...
                if (item != null) {
                    if (MapleItemInformationProvider.getInstance()
                            ...
                            && chr.haveItemWithId(item.getItemId(), true)) {
                ...
                if ((meso > 0 && storageMesos >= meso) || (meso < 0 && playerMesos >= -meso)) {
                    ...
                    FilePrinter.print(
                            FilePrinter.STORAGE + c.getPlayer().getName() + ".txt",
                            c.getPlayer().getName()
                                    + (meso > 0 ? " took out " : " stored ")
                                    + Math.abs(meso)
                                    + " mesos"
                                    + System.lineSeparator());
                    chr.setUsedStorage();
