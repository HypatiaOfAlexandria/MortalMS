...
public enum MapleJob {
    ...
    final int jobid;
    static final int maxId = 22; // maxId = (EVAN / 100);
    ...
    public static boolean isBeginner(MapleJob beginners) {
    ...
    public boolean isA(
            MapleJob basejob) { // thanks Steve (kaito1410) for pointing out an improvement here
        int basebranch = basejob.jobid / 10;
        return (jobid / 10 == basebranch && jobid >= basejob.jobid)
                || (basebranch % 10 == 0 && jobid / 100 == basejob.jobid / 100);
    }
