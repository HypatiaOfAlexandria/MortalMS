...
public class MapleRing implements Comparable<MapleRing> {
    ...
    public static MapleRing loadFromDb(int ringId) {
        try {
            ...
            PreparedStatement ps =
                    con.prepareStatement("SELECT * FROM rings WHERE id = ?"); // Get ring details..
            ps.setInt(1, ringId);
    ...
    public static void removeRing(final MapleRing ring) {
        try {
            ...
            ps.setInt(1, ring.ringId);
            ps.addBatch();

            ps.setInt(1, ring.ringId2);
            ps.addBatch();
    ...
    public static int createRing(
            int itemid, final MapleCharacter partner1, final MapleCharacter partner2) {
        try {
            if (partner1 == null) {
                return -2;
            }
    ...
    public boolean equals(Object o) {
        return o instanceof MapleRing && ((MapleRing) o).ringId == ringId;
    }
