...
public class PetDataFactory {
    ...
    public static PetCommand getPetCommand(int petId, int skillId) {
        PetCommand ret = petCommands.get(petId + String.valueOf(skillId));
        if (ret != null) {
            return ret;
        }
        synchronized (petCommands) {
            ret = petCommands.get(petId + String.valueOf(skillId));
            if (ret == null) {
                ...
                petCommands.put(petId + String.valueOf(skillId), ret);
            }
            return ret;
        }
    }
