...
public class AutoJCE { // AutoJCE into server source thanks to Acernis dev team
    ...
    /** Credits: ntoskrnl of StackOverflow http://stackoverflow.com/questions/1179672/ */
    public static byte removeCryptographyRestrictions() {
        ...
        try {
            ...
            final Field isRestrictedField =
                    jceSecurity.getDeclaredField(
                            "isRestricted"); // was set to final in Java 8 Update 112. Requires you
            // to remove the final modifier.
            Field modifiersField = Field.class.getDeclaredField("modifiers");
            modifiersField.setAccessible(true);
            modifiersField.setInt(
                    isRestrictedField, isRestrictedField.getModifiers() & ~Modifier.FINAL);
