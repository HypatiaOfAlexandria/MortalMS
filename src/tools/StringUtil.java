...
public class StringUtil {
    /**
     * Gets a string padded from the left to {@code length} by <code>padchar</code>.
     *
    ...
    /**
     * Gets a string padded from the right to {@code length} by <code>padchar</code>.
     *
     * @param in The input string to be padded.
     * @param padchar The character to pad with.
     * @param length The length to pad to.
    ...
    /**
     * Joins an array of strings starting from string {@code start} with a space.
     *
    ...
    /**
     * Joins an array of strings starting from string {@code start} with <code>sep</code> as a
     * seperator.
     *
     * @param arr The array of strings to join.
     * @param start Starting from which string.
    ...
    /**
     * Counts the number of {@code chr}'s in <code>str</code>.
     *
     * @param str The string to check for instances of {@code chr}.
     * @param chr The character to check for.
     * @return The number of times {@code chr} occurs in <code>str</code>.
     */
