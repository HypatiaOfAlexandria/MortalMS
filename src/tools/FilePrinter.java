...
public class FilePrinter {
    ...
    private static final SimpleDateFormat sdf =
            new SimpleDateFormat(
                    "yyyy-MM-dd"); // for file system purposes, it's nice to use yyyy-MM-dd
    ...
    public static void printError(final String name, final Throwable t) {
        ...
        try {
            ...
            out.write(getString(t).getBytes(StandardCharsets.UTF_8));
            out.write(
    ...
    public static void printError(final String name, final Throwable t, final String info) {
        ...
        try {
            ...
            out = new FileOutputStream(file, true);
            out.write((info + System.lineSeparator()).getBytes(StandardCharsets.UTF_8));
            out.write(getString(t).getBytes(StandardCharsets.UTF_8));
            out.write(
                    (System.lineSeparator()
                                    + "---------------------------------"
