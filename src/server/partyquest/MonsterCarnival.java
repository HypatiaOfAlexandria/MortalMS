...
public class MonsterCarnival {
    private final MonsterCarnivalParty red;
    private final MonsterCarnivalParty blue;
    ...
    public MonsterCarnival(
            int room, byte channel, MonsterCarnivalParty red1, MonsterCarnivalParty blue1) {
        ...
        for (MapleCharacter chr : red.getMembers()) chr.setCarnival(this);
        for (MapleCharacter chr : blue.getMembers()) chr.setCarnival(this);
    ...
    public void saveResults() {
        ...
        try {
            ...
            PreparedStatement ps =
                    con.prepareStatement("INSERT INTO carnivalresults VALUES (?,?,?,?)");
