...
public class MaplePlayerNPCFactory {
    ...
    public static void loadDeveloperRoomMetadata(MapleDataProvider npc) {
        ...
        if (thisData != null) {
            ...
            if (thisData != null) {
                MapleDataProvider sound =
                        MapleDataProviderFactory.getDataProvider(new File("wz/Sound.wz"));
    ...
    public static void loadFactoryMetadata() {
        ...
        if (dnpcData != null) {
            for (MapleData data : dnpcData.getChildren()) {
                ...
                List<MaplePlayerNPC> dnpcSet =
                        dnpcMaps.computeIfAbsent(mapid, k -> new ArrayList<>());
            ...
            if (thisData != null) {
                ...
                String name = new String(encData, StandardCharsets.UTF_8);
