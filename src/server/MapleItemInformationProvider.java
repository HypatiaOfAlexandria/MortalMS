...
public class MapleItemInformationProvider {
    ...
    private static short getExtraSlotMaxFromPlayer(MapleClient c, int itemId) {
        ...
        if (ItemConstants.isThrowingStar(itemId)) {
            ret +=
                    c.getPlayer().getJob().isA(MapleJob.NIGHTWALKER1)
                            ? c.getPlayer()
                                            .getSkillLevel(
                                                    SkillFactory.getSkill(NightWalker.CLAW_MASTERY))
                                    * 10
                            : c.getPlayer()
                                            .getSkillLevel(
                                                    SkillFactory.getSkill(Assassin.CLAW_MASTERY))
                                    * 10;
    ...
    public short getSlotMax(MapleClient c, int itemId) {
        ...
        if (item != null) {
            ...
            if (smEntry == null) {
                ret =
                        (short)
                                (ItemConstants.getInventoryType(itemId).getType()
    ...
    public static void scrollOptionEquipWithChaos(Equip nEquip, int range, boolean option) {
        ...
        if (!option) {
            if (nEquip.getStr() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    ...
                    nEquip.setStr(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getStr() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getDex() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setDex(
                    ...
                    nEquip.setDex(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getDex() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getInt() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setInt(
                    ...
                    nEquip.setInt(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getInt() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getLuk() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setLuk(
                    ...
                    nEquip.setLuk(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getLuk() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getAcc() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setAcc(
                    ...
                    nEquip.setAcc(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getAcc() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getAvoid() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    ...
                    nEquip.setAvoid(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getAvoid() + chscrollRandomizedStat(range))));
            }
        } else {
            if (nEquip.getWatk() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    ...
                    nEquip.setWatk(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getWatk() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getWdef() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setWdef(
                    ...
                    nEquip.setWdef(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getWdef() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getMatk() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setMatk(
                    ...
                    nEquip.setMatk(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getMatk() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getMdef() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setMdef(
                    ...
                    nEquip.setMdef(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getMdef() + chscrollRandomizedStat(range))));
            }
            ...
            if (nEquip.getSpeed() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    ...
                    nEquip.setSpeed(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getSpeed() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getJump() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setJump(
                    ...
                    nEquip.setJump(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getJump() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getHp() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setHp(
                    ...
                    nEquip.setHp(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getHp() + chscrollRandomizedStat(range))));
            }
            if (nEquip.getMp() > 0) {
                if (ServerConstants.USE_ENHANCED_CHSCROLL)
                    nEquip.setMp(
                    ...
                    nEquip.setMp(
                            getMaximumShortMaxIfOverflow(
                                    0, (nEquip.getMp() + chscrollRandomizedStat(range))));
            }
        }
    }

    private static void scrollEquipWithChaos(Equip nEquip, int range) {
        if (ServerConstants.CHSCROLL_STAT_RATE > 0) {
            ...
            for (int i = 0; i < ServerConstants.CHSCROLL_STAT_RATE; i++) {
                if (nEquip.getStr() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curStr + chscrollRandomizedStat(range)
                                    : nEquip.getStr() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getDex() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curDex + chscrollRandomizedStat(range)
                                    : nEquip.getDex() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getInt() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curInt + chscrollRandomizedStat(range)
                                    : nEquip.getInt() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getLuk() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curLuk + chscrollRandomizedStat(range)
                                    : nEquip.getLuk() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getWatk() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curWatk + chscrollRandomizedStat(range)
                                    : nEquip.getWatk() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getWdef() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curWdef + chscrollRandomizedStat(range)
                                    : nEquip.getWdef() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getMatk() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curMatk + chscrollRandomizedStat(range)
                                    : nEquip.getMatk() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getMdef() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curMdef + chscrollRandomizedStat(range)
                                    : nEquip.getMdef() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getAcc() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curAcc + chscrollRandomizedStat(range)
                                    : nEquip.getAcc() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getAvoid() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curAvoid + chscrollRandomizedStat(range)
                                    : nEquip.getAvoid() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getSpeed() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curSpeed + chscrollRandomizedStat(range)
                                    : nEquip.getSpeed() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getJump() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curJump + chscrollRandomizedStat(range)
                                    : nEquip.getJump() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getHp() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curHp + chscrollRandomizedStat(range)
                                    : nEquip.getHp() + chscrollRandomizedStat(range);
                ...
                if (nEquip.getMp() > 0) {
                    temp =
                            ServerConstants.USE_ENHANCED_CHSCROLL
                                    ? curMp + chscrollRandomizedStat(range)
                                    : nEquip.getMp() + chscrollRandomizedStat(range);
    ...
    public Item scrollEquipWithId(
            Item equip, int scrollId, boolean usingWhiteScroll, int vegaItemId, boolean isGM) {
        ...
        if (equip instanceof Equip) {
            ...
            if (((nEquip.getUpgradeSlots() > 0 || ItemConstants.isCleanSlate(scrollId)))
                    || assertGM) {
                ...
                if (assertGM || rollSuccessChance(prop)) {
                    ...
                    if (!ServerConstants.USE_PERFECT_SCROLLING
                            && !usingWhiteScroll
    ...
    public static void improveEquipStats(Equip nEquip, Map<String, Integer> stats) {
        for (Entry<String, Integer> stat : stats.entrySet()) {
            switch (stat.getKey()) {
                case "STR":
                    nEquip.setStr(
                            getShortMaxIfOverflow(nEquip.getStr() + stat.getValue().intValue()));
                    break;
                case "DEX":
                    nEquip.setDex(
                            getShortMaxIfOverflow(nEquip.getDex() + stat.getValue().intValue()));
                    break;
                case "INT":
                    nEquip.setInt(
                            getShortMaxIfOverflow(nEquip.getInt() + stat.getValue().intValue()));
                    break;
                case "LUK":
                    nEquip.setLuk(
                            getShortMaxIfOverflow(nEquip.getLuk() + stat.getValue().intValue()));
                    break;
                case "PAD":
                    nEquip.setWatk(
                            getShortMaxIfOverflow(nEquip.getWatk() + stat.getValue().intValue()));
                    break;
                case "PDD":
                    nEquip.setWdef(
                            getShortMaxIfOverflow(nEquip.getWdef() + stat.getValue().intValue()));
                    break;
                case "MAD":
                    nEquip.setMatk(
                            getShortMaxIfOverflow(nEquip.getMatk() + stat.getValue().intValue()));
                    break;
                case "MDD":
                    nEquip.setMdef(
                            getShortMaxIfOverflow(nEquip.getMdef() + stat.getValue().intValue()));
                    break;
                case "ACC":
                    nEquip.setAcc(
                            getShortMaxIfOverflow(nEquip.getAcc() + stat.getValue().intValue()));
                    break;
                case "EVA":
                    nEquip.setAvoid(
                            getShortMaxIfOverflow(nEquip.getAvoid() + stat.getValue().intValue()));
                    break;
                case "Speed":
                    nEquip.setSpeed(
                            getShortMaxIfOverflow(nEquip.getSpeed() + stat.getValue().intValue()));
                    break;
                case "Jump":
                    nEquip.setJump(
                            getShortMaxIfOverflow(nEquip.getJump() + stat.getValue().intValue()));
                    break;
                case "MHP":
                    nEquip.setHp(
                            getShortMaxIfOverflow(nEquip.getHp() + stat.getValue().intValue()));
                    break;
                case "MMP":
                    nEquip.setMp(
                            getShortMaxIfOverflow(nEquip.getMp() + stat.getValue().intValue()));
                    break;
                case "afterImage":
                    break;
            }
    ...
    public static Equip randomizeStats(Equip equip) {
    ...
    public static Equip randomizeUpgradeStats(Equip equip) {
    ...
    public boolean isQuestItem(int itemId) {
        ...
        MapleData data = getItemData(itemId);
        boolean questItem =
                (data != null && MapleDataTool.getIntConvert("info/quest", data, 0) == 1);
    ...
    public boolean isPartyQuestItem(int itemId) {
        ...
        boolean partyquestItem =
                (data != null && MapleDataTool.getIntConvert("info/pquest", data, 0) == 1);
    ...
    public boolean isUntradeableOnEquip(int itemId) {
        ...
        boolean untradableOnEquip =
                MapleDataTool.getIntConvert("info/equipTradeBlock", getItemData(itemId), 0) > 0;
    ...
    public boolean isKarmaAble(int itemId) {
        ...
        boolean bRestricted =
                MapleDataTool.getIntConvert("info/tradeAvailable", getItemData(itemId), 0) > 0;
    ...
    public Pair<Integer, List<RewardItem>> getItemReward(
            int itemId) { // Thanks Celino, used some stuffs :)
    ...
    public Collection<Item> canWearEquipment(MapleCharacter chr, Collection<Item> items) {
        ...
        Collection<Item> itemz = new ArrayList<>();
        ...
        for (Item item : items) {
            ...
            if (getEquipStats(equip.getItemId()).get("reqDEX") > tdex) {
                continue;
            }
            if (getEquipStats(equip.getItemId()).get("reqSTR") > tstr) {
                continue;
            }
            if (getEquipStats(equip.getItemId()).get("reqLUK") > tluk) {
                continue;
            }
            if (getEquipStats(equip.getItemId()).get("reqINT") > tint) {
                continue;
            }
    ...
    public boolean canWearEquipment(MapleCharacter chr, Equip equip, int dst) {
        ...
        if (ItemConstants.isWeddingRing(id) && chr.hasJustMarried()) {
            chr.dropMessage(
                    5,
                    "The Wedding Ring cannot be equipped on this map."); // will dc everyone due to
            // doubled couple effect
            return false;
        }
                    ...
                    .broadcastGMMessage(
                            ...
                            MaplePacketCreator.sendYellowTip(
                                    "[WARNING]: "
                                            ...
                                            + dst
                                            + '.'));
            AutobanFactory.PACKET_EDIT.alert(
                    chr, chr.getName() + " tried to forcibly equip an item.");
            FilePrinter.printError(
                    FilePrinter.EXPLOITS + chr.getName() + ".txt",
                    chr.getName()
                            + " tried to equip "
                            + itemName
                            + " into "
    ...
    public static ArrayList<Pair<Integer, String>> getItemDataByName(String name) {
                                    ...
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    ...
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incDEXMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incSTRMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incINTMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incLUKMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incMHPMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incMMPMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incPADMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incMADMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incPDDMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incMDDMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incACCMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incEVAMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incSpeedMax")))));
                            ...
                            list.add(
                                    new Pair<>(
                                            ...
                                            Randomizer.rand(
                                                    MapleDataTool.getInt(da),
                                                    MapleDataTool.getInt(
                                                            data2.getChildByPath("incJumpMax")))));
                        }
                    }
                }
            }
        ...
        try {
            ...
            PreparedStatement ps =
                    con.prepareStatement(
                            "SELECT stat, value FROM makerreagentdata WHERE itemid = ?");
            ps.setInt(1, itemId);
    ...
    public int getMakerCrystalFromLeftover(Integer leftoverId) {
        try {
            ...
            PreparedStatement ps =
                    con.prepareStatement(
                            "SELECT dropperid FROM drop_data WHERE itemid = ? ORDER BY dropperid;");
    ...
    public MakerItemCreateEntry getMakerItemEntry(int toCreate) {
        ...
        try {
            ...
            ps =
                    con.prepareStatement(
                            "SELECT req_item, count FROM makerrecipedata WHERE itemid = ?");
            ps.setInt(1, toCreate);
            rs = ps.executeQuery();
            while (rs.next()) {
    ...
    public static int getMakerDisassembledQuantity(Integer itemId) {
        int avail = 0;
        Connection con;
        try {
            con = DatabaseConnection.getConnection();
            PreparedStatement ps =
                    con.prepareStatement(
                            "SELECT count FROM makerrecipedata WHERE itemid = ? AND req_item >= 4260000 AND req_item <= 4260008 ORDER BY count DESC");
            ps.setInt(1, itemId);
            ResultSet rs = ps.executeQuery();

            if (rs.next()) {
                avail = (rs.getInt("count") + 1) / 2; // return to the player half of the crystals
                // needed
            }
    ...
    public static int getMakerDisassembledFee(Integer itemId) {
        int fee = -1;
        Connection con;
        try {
            con = DatabaseConnection.getConnection();
            PreparedStatement ps =
                    con.prepareStatement("SELECT req_meso FROM makercreatedata WHERE itemid = ?");
            ps.setInt(1, itemId);
            ResultSet rs = ps.executeQuery();
    ...
    public int getMakerStimulant(int itemId) { // thanks to Arnah
        ...
        for (MapleData md : etcData.getData("ItemMake.img").getChildren()) {
            MapleData me =
                    md.getChildByPath(
                            StringUtil.getLeftPaddedStr(Integer.toString(itemId), '0', 8));
    ...
    public static Set<String> getWhoDrops(Integer itemId) {
        ...
        try {
            ...
            while (rs.next()) {
                String resultName =
                        MapleMonsterInformationProvider.getMobNameFromId(rs.getInt("dropperid"));
                if (resultName != null) {
                    list.add(resultName);
                }
            }
    ...
    private boolean canUseSkillBook(MapleCharacter player, Integer skillBookId) {
        ...
        return (skilldata.get("skillid") != 0
                && ((player.getSkillLevel(skill2) >= skilldata.get("reqSkillLevel")
    ...
    public List<Integer> usableMasteryBooks(MapleCharacter player) {
        List<Integer> masterybook = new ArrayList<>();
    ...
    public List<Integer> usableSkillBooks(MapleCharacter player) {
        List<Integer> skillbook = new ArrayList<>();
