...
public final class MapleOxQuiz {
    ...
    private static final MapleDataProvider stringData =
    ...
    private static boolean isCorrectAnswer(MapleCharacter chr, int answer) {
                ...
                .schedule(
                        () -> {
                            map.broadcastMessage(
                                    MaplePacketCreator.showOXQuiz(round, question, true));
                            ...
                            if (map.getCharacters().size() - number <= 2) {
                                map.broadcastMessage(
                                        MaplePacketCreator.serverNotice(6, "The event has ended"));
                        ...
                        30000); // Time to answer = 30 seconds ( Ox Quiz packet shows a 30 second
        // timer.
    }

    private static int getOXAnswer(int imgdir, int id) {
        return MapleDataTool.getInt(
                stringData
                        .getData("OXQuiz.img")
