...
public final class GuildOperationHandler extends AbstractMaplePacketHandler {
    ...
    private final java.util.List<Invited> invited = new java.util.ArrayList<>();
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        switch (type) {
            ...
            case 0x02:
                            ...
                            .dropMessage(
                                    ...
                                    "You do not have "
                                            + GameConstants.numberWithCommas(
                                                    ServerConstants.CREATE_GUILD_COST)
                ...
                int gid = Server.createGuild(mc.getId(), guildName);
                if (gid == 0) {
                ...
                Server.getInstance()
                        .getGuild(mc.getGuildId(), mc.getWorld(), mc); // initialize guild structure
            ...
            case 0x06:
                ...
                if (s == 0) {
                    c.getPlayer()
                            .dropMessage(1, "The Guild you are trying to join is already full.");
                ...
                if (mc.getMeso() < ServerConstants.CHANGE_EMBLEM_COST) {
                    c.announce(
                            MaplePacketCreator.serverNotice(
                                    ...
                                    "You do not have "
                                            + GameConstants.numberWithCommas(
                                                    ServerConstants.CHANGE_EMBLEM_COST)
