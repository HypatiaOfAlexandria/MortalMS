...
public class PartySearchStartHandler extends AbstractMaplePacketHandler {
    ...
    private static boolean isValidJob(MapleJob thejob, int jobs) {
        ...
        if (jobid > 100 && jobid < 113) {
            return ((jobs & 8) > 0);
        }
        if (jobid > 110 && jobid < 123) {
            return ((jobs & 16) > 0);
        }
        if (jobid > 120 && jobid < 133) {
            return ((jobs & 32) > 0);
        }
        if (jobid == 200) {
            return ((jobs & 64) > 0);
        }
        if (jobid > 209 && jobid < 213) {
            return ((jobs & 128) > 0);
        }
        if (jobid > 219 && jobid < 223) {
            return ((jobs & 256) > 0);
        }
        if (jobid > 229 && jobid < 233) {
            return ((jobs & 512) > 0);
        }
        if (jobid == 500) {
            return ((jobs & 1024) > 0);
        }
        if (jobid > 509 && jobid < 513) {
            return ((jobs & 2048) > 0);
        }
        if (jobid > 519 && jobid < 523) {
            return ((jobs & 4096) > 0);
        }
        if (jobid == 400) {
            return ((jobs & 8192) > 0);
        }
        if (jobid > 400 && jobid < 413) {
            return ((jobs & 16384) > 0);
        }
        if (jobid > 419 && jobid < 423) {
            return ((jobs & 32768) > 0);
        }
        if (jobid == 300) {
            return ((jobs & 65536) > 0);
        }
        if (jobid > 300 && jobid < 313) {
            return ((jobs & 131072) > 0);
        }
        return jobid > 319 && jobid < 323 && (jobs & 262144) > 0;
    }
}
