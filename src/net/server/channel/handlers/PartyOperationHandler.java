...
public final class PartyOperationHandler extends AbstractMaplePacketHandler {
    ...
    public static void leaveParty(
            MapleParty party, MaplePartyCharacter partyplayer, MapleClient c) {
        ...
        switch (operation) {
                ...
                if (player.getParty() == null) {
                    ...
                    c.announce(
                            MaplePacketCreator.serverNotice(
                                    5, "You can't create a party as you are already in one."));
                }
                break;
            case 2:
                // leave/disband
            ...
            case 3:
                ...
                if (player.getParty() == null) {
                    ...
                    c.announce(
                            MaplePacketCreator.serverNotice(
                                    5, "You can't join the party as you are already in one."));
                }
                break;
            case 4:
                // invite
                ...
                if (invited != null) {
                    if (invited.getLevel() < 10
                            && (!ServerConstants.USE_PARTY_FOR_STARTERS
                                    || player.getLevel() >= 10)) { // min requirement is level 10
                        c.announce(
                                MaplePacketCreator.serverNotice(
                                        5,
                    ...
                    if (ServerConstants.USE_PARTY_FOR_STARTERS
                            && invited.getLevel() >= 10
                            && player.getLevel() < 10) { // trying to invite high level
                        c.announce(
                                MaplePacketCreator.serverNotice(
                                        5,
                                        "The player you have invited does not meet the requirements."));
