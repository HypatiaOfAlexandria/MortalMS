        ...
        switch (itemId) {
            case 2270000:
                if (mob.getId() == 9300101) {
                    chr.getMap()
                            .broadcastMessage(
                                    MaplePacketCreator.catchMonster(monsterid, itemId, (byte) 1));
                    mob.getMap().killMonster(mob, null, false);
                    MapleInventoryManipulator.removeById(
                            c, MapleInventoryType.USE, itemId, 1, true, true);
            ...
            case 2270008:
                ...
                break;
            default:
                // System.out.println("UseCatchItemHandler: " + System.lineSeparator() + "" +
                // slea.toString());
        }
    }
}
