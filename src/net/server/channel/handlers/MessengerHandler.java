        ...
        switch (mode) {
                ...
                if (messenger == null) {
                    ...
                    if (messengerid == 0) {
                        MapleMessengerCharacter messengerplayer =
                                new MapleMessengerCharacter(player, 0);
            ...
            case 0x05:
                ...
                if (target != null) {
                    if (target.getMessenger() != null) {
                        target.getClient()
                                .announce(MaplePacketCreator.messengerNote(player.getName(), 5, 0));
                    }
                } else {
            ...
            case 0x06:
                if (messenger != null) {
                    MapleMessengerCharacter messengerplayer =
                            new MapleMessengerCharacter(player, player.getMessengerPosition());
                    input = slea.readMapleAsciiString();
