...
public abstract class AbstractMovementPacketHandler extends AbstractMaplePacketHandler {
                ...
                case 11: // chair
                    {
                        ...
                        byte newstate = lea.readByte();
                        TeleportMovement tm =
                                new TeleportMovement(command, new Point(xpos, ypos), newstate);
    ...
    protected static void updatePosition(
            List<LifeMovementFragment> movement, AnimatedMapleMapObject target, int yoffset) {
