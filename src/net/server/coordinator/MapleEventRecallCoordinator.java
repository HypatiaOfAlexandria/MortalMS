...
public class MapleEventRecallCoordinator {
    ...
    private static final MapleEventRecallCoordinator instance = new MapleEventRecallCoordinator();

    public static MapleEventRecallCoordinator getInstance() {
        return instance;
    }

    private final ConcurrentHashMap<Integer, EventInstanceManager> eventHistory =
